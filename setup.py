...
vite_config_ts = r"""import { defineConfig } from 'vite'
...
tailwind_config_js = r"""/** @type {import('tailwindcss').Config} */
export default {
  content: [
    "./index.html",
    "./src/**/*.{js,ts,jsx,tsx}",
...
postcss_config_js = r"""export default {
  plugins: {
    tailwindcss: {},
    autoprefixer: {},
  },
...
<html lang="en">
  <head>
    ...
    <title>Keen Slider Showcase</title>
  </head>
  <body>
    <div id="root"></div>
...
src_main_tsx = r"""import React from 'react'
...
github_workflow_yml = r"""# Simple workflow for deploying static content to GitHub Pages
...
import { Copy, Check, ChevronLeft, ChevronRight, Layout, Maximize, Layers, Box, Smartphone, Upload, Trash2, Gauge, Monitor, RectangleHorizontal, RectangleVertical, Square, CreditCard, Cuboid } from 'lucide-react';
